...
public class UserInfoID {
	 private Long userInfoId;
	    ...
	    private Byte userInfoIsDeleted;
	    ...
	    private Long idInfoVersion;
	    private Byte idInfoIsDeleted;
		...
		public String toString() {
			return "UserInfoID [userInfoId=" + userInfoId + ", userName="
					...
					+ userInfoVersion + ", userInfoIsDeleted="
					+ userInfoIsDeleted + ", idInfoId=" + idInfoId + ", sex="
					+ sex + ", nation=" + nation + ", nationId=" + nationId
					+ ", birthday=" + birthday + ", address=" + address
					+ ", phone=" + phone + ", cerNo=" + cerNo + ", authority="
					+ authority + ", effecDuration=" + effecDuration
