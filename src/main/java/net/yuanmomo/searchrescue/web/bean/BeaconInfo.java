...
public class BeaconInfo extends BeaconInfoKey implements Serializable {
	...
	public boolean equals(Object that) {
		...
		return (this.getId() == null ? other.getId() == null : this.getId()
				...
				&& (this.getBeaconNo() == null ? other.getBeaconNo() == null
						: this.getBeaconNo().equals(other.getBeaconNo()))
				...
				&& (this.getLastUpdateByUserStyle() == null ? other
						.getLastUpdateByUserStyle() == null : this
						.getLastUpdateByUserStyle().equals(
								other.getLastUpdateByUserStyle()))
				&& (this.getLastUpdateByUserId() == null ? other
						.getLastUpdateByUserId() == null : this
						.getLastUpdateByUserId().equals(
								other.getLastUpdateByUserId()))
	...
	public int hashCode() {
		...
		result = prime * result
				+ ((getBeaconNo() == null) ? 0 : getBeaconNo().hashCode());
		result = prime * result
		...
		result = prime
				* result
				+ ((getLastUpdateByUserStyle() == null) ? 0
						: getLastUpdateByUserStyle().hashCode());
		result = prime
				* result
				+ ((getLastUpdateByUserId() == null) ? 0
						: getLastUpdateByUserId().hashCode());
		result = prime * result
